...
def his_introduction(w: World):
    ...
    return w.scene("自己紹介",
            ...
            kyo.do("約束、というワードに一瞬軽い目眩がした"),
            kyo.do("彼、宮内翔太郎は立ち上がるときょう子に毛糸を渡し、階段を降りる。私の前に立つとほぼ目線の高さが同じだ。黒目の大きなとても澄んだ瞳がぼんやり照らされ、じっと向けられた"),
            kyo.talk("どうしてきょう子が見えるんですか？"),
            kyo.do("けれど彼は首を傾げ、意味の分からない苦笑を浮かべる"),
...
def shotaro_again(w: World):
    ...
    return w.scene("$shota現れる",
            ...
            kyo.do("そんなことを考えながら路地を曲がるとアパートが見えてくる",
                "$Mは少しペダルを漕ぐ力を緩め、$sjkyokoたちの姿が頭を過り始めると、", "&"),
            ...
            kyo.do("横並びになると彼が私とそう差のない背丈であることがよく分かった",
                    "少なくとも百七十はない",
                    "松本のように筋肉質という訳でもなく、色白で手足が細く、やや丸めた背中は猫のような印象を抱かせた"),
            kyo.talk("それ、返して下さい"),
            sho.talk("部屋まで持ってくけど？"),

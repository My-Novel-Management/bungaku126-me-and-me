...
def his_introduction(w: World):
    ...
    return w.scene("自己紹介",
            w.cmd.change_stage("Apart"),
            kyo.do("私に微笑み掛けながらその指に赤い毛糸で三本線の川を作って見せている彼は、何も返事がないことに僅かに眉を顰《しか》めると、再度言った"),
            sho.talk("今日子さん？　おかえりだよ"),
            sk.talk("おかえりだよ。キャハハ"),
            kyo.do("その青年の右肩に両手を載せて笑い声を上げながら飛び上がるのは、十歳の頃の私だ。けれど本当ならそれは、私以外に見えるはずのないＩＦ、イマジナリーフレンドだった"),
            kyo.talk("ねえ……あなたって、何者？"),
            kyo.do("外灯の明かりでスチール製の階段に座っている彼の姿がぼんやりと見えているけれど、その白い肌の所為《せい》か、薄っすら浮かんでいるようにすら感じる。サラサラの細い髪がアイドルグループの誰かみたいに眉の上で切り揃《そろ》えられていて、二重のころころとした瞳が小動物を思わせた"),
            sho.talk("宮内翔太郎《みやうちしょうたろう》という名前に心当たりはある？"),
            ...
            kyo.do("幽霊？"),
            kyo.do("そんな可能性を思いついて恐くなり、私は慌てて彼を迂回すると、"),
            kyo.talk("さっさと家に入って"),
            kyo.do("口を結んでほっぺを膨らませたきょう子の手を取り、階段を駆け上がる"),
...
def shotaro_again(w: World):
    ...
    return w.scene("$shota再び",
            ...
            kyo.do("思わず急ブレーキを掛けて止まると、振り返って彼がいた外灯の下を見る"),
            sho.talk("こんばーんは"),
            kyo.do("丈の短いズボンのポケットに手を戻すと、そう言って、ニッと笑う"),
            kyo.do("悪意の欠片もない子どもの笑顔だ。よくきょう子もする。けれどその無垢さが一番害になることだって多々あった"),
            kyo.talk("何か用ですか？"),
            kyo.do("できるだけ冷たく言い放ってみたけれど、彼は慄いた様子もなく楽しげに歩いて近づくと、私の周囲の匂いを嗅ぎ取る"),
            kyo.talk("な、何なのよ？"),
            sho.talk("魚臭い"),
            ...
            kyo.talk("冷凍しておくから"),
            sho.talk("今日子って嘘を付く時ちょっと上を向いて鼻を膨《ふく》らますよね"),
            kyo.do("それはキョウコに言われて初めて気づいた自分の癖だった"),
            kyo.talk("なんであなたがそんなこと知ってるの？"),
            kyo.do("彼は目を細めて笑ってから背を向けると、"),
            sho.talk("なんで？　って言いたいのはこっちなんだけどなあ"),
            kyo.do("クスクスと声を漏らしながら外灯のスポットライトに入り、くるり、と私を振り返った"),
            sho.talk("今日子、忘れちゃった？　それとも記憶から消したの？　大事な約束のこと"),
            kyo.do("やくそく。と心の中で復唱する"),
            kyo.do("私の二十年余りの人生のアルバムには一枚も彼が写った写真なんてない。それなのに混じり気のない純粋な笑顔は、確かに見覚えがある"),
            kyo.talk("いつ頃の話なの？　私、実はいくつか記憶が抜けている時期があるの。もしその時の私と出会って何か約束をしたというなら、その私は私じゃないから"),
            kyo.do("自分でも何を言っているのだろうとは思う。彼は小首を傾げ、私の表情を覗き込むように視線を投げている"),
            kyo.talk("あなたに説明しても分からないと思うけど、私ってね、他人とはちょっと違うの。ちょっとだけおかしいところがあるの。昨日あなたが見たという女の子。彼女は現実には存在しないの。でも私はそういうものが見える。見えないものが見えるのよ"),
            sho.talk("幽霊ってこと？"),
            kyo.talk("違うけど、でも似たようなもの。本来なら私以外には見えないものなのよ、彼女たちは"),
            sho.talk("たち？　他にもいるの？"),
            kyo.do("喋りすぎた。追い払おうとして饒舌《じょうぜつ》になりすぎた"),
            kyo.do("よくやる失敗だった。こういう時に人付き合いの不慣れさというものが露呈し易い。それも相手が異性なら尚更だ"),
            kyo.do("私は「とにかくごめんなさい」とだけ言って、自転車を押してアパートの駐輪場に向かう"),
            ...
            kyo.do("横並びになると彼が私とそう差のない背丈であることがよく分かる。少なくとも百七十はない。松本のように筋肉質という訳でもなく、色白で猫のような柔らかい髪の毛をしていた"),
            kyo.do("自転車を停めると、私は彼に向かって手を差し出す"),
            kyo.talk("それ、返して下さい"),
            sho.talk("部屋まで持ってくけど？"),
            kyo.talk("そんなことしたらあなたを入れないといけないでしょう？　小さい頃に教わらなかったんですか？　知らない人を勝手に家に上げてはいけないって"),
            kyo.do("小さな男の子に言い聞かせるような口ぶりになってしまったけれど、しゅんと俯いた彼にはこちらを保育士のような気にさせる趣《おもむき》があった"),
            sho.talk("今日子って、そういうとこあるよね"),
            kyo.talk("それとね、どうして私のこと名前で呼び捨てにするの？　それがまず失礼だとか思わないんですか？"),
            kyo.do("けれど彼は首を捻《ひね》る。他人に対して失礼という感覚がないのかも知れない。もしそうなら本当に子供心のまま大きくなってしまった人間なのだろう"),
            kyo.talk("とにかく返して下さい"),

...
def friend_and_circle(w: World):
    ...
    return w.scene('サークル',
            ...
            kyo.do("この日はしっかり五講まで入っていて最後の英語の講義を終えた後でぼんやりとした眠気と共に教室を出た"),
            kyo.do("午前中に降り続いていた雨が色々と洗い流してくれた為か、いつもより夕空が綺麗な気がする",
                "それでも体はすっかり気だるくて二十歳を超えた自分から体力というものが日に日に失われていっているような心地になってしまう"),
            ...
            kyo.do("暫く行くとベンチの前に座る幸子と椚木先輩の姿を見つけ、私は小走りになって彼女たちの前に向かう。先輩の方は今日も相変わらず上下とも黒のぴったりした服を着ていて、腰に手を当てた立ち姿のパンツのラインがモデルのようだ"),
